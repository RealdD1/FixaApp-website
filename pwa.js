...
(function () {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
      ...
      // If yes, a later controllerchange means a genuine update. If no (first-ever
      // visit, or first load after a cache clear), clients.claim() will cause an
      // initial controllerchange too — that one must NOT trigger a reload, or every
      // first-time visitor gets bounced mid-load.
